        ...
        <div className="flex items-center gap-6 cursor-pointer">
          ...
          <div className="relative">
            <button
              ...
              className="rounded-full bg-green-700 text-white w-9 h-9 flex items-center justify-center text-lg shadow cursor-pointer hover:bg-green-800"
            >
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 flex items-center justify-between bg-white shadow-md px-4 py-3 w-full rounded-none z-50">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              onClick={() => setShowInfo((s) => !s)}
              className="rounded-full bg-green-700 text-white w-7 h-7 flex items-center justify-center text-sm shadow cursor-pointer ml-2 hover:bg-green-800"
            >
              {userData?.fullName?.slice(0, 1).toUpperCase()}
            </button>
            {showInfo && (
