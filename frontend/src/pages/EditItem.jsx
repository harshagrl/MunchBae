...
import { FaRupeeSign, FaImage, FaUtensils, FaSave } from "react-icons/fa";
        ...
        <div className="text-center">
          <div className="inline-flex items-center gap-3 bg-white/70 backdrop-blur-sm rounded-full px-6 py-3 shadow-md border border-white/50 mb-4">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#e84c3d] to-orange-400 flex items-center justify-center shadow-md">
              <FaPenToSquare className="text-white w-5 h-5" />
            </div>
            <span className="text-lg font-bold text-[#2d2d2d]">
              Edit <span className="text-[#e84c3d]">Food Item</span>
            </span>
          </div>
          <p className="text-gray-500 text-sm max-w-md mx-auto">
            Update the details of your menu item below. Changes will be reflected immediately.
          </p>
        </div>

        {/* Loading State */}
        {fetching ? (
          <div className="bg-white/80 backdrop-blur-md shadow-2xl rounded-3xl overflow-hidden border border-white/50 p-16 flex flex-col items-center justify-center gap-4">
            <ClipLoader size={40} color="#e84c3d" />
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-white text-xl font-extrabold">
                    {currentItem?.name || "Edit Item"}
                  </h2>
                  <p className="text-white/80 text-sm">Modify your menu item details</p>
                </div>
              </div>
            </div>
            ...
            {frontendImage && !backendImage && (
              <div className="relative group">
                ...
                <div className="absolute bottom-4 left-6">
                  <span className="bg-white/90 backdrop-blur-sm text-[#2d2d2d] px-3 py-1.5 rounded-full text-xs font-semibold shadow-md">
                    Current Image
                  </span>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 md:p-8 flex flex-col gap-5">
              ...
              <div>
                ...
                {backendImage && frontendImage && (
                  <div className="mt-4 rounded-2xl overflow-hidden border-2 border-white shadow-lg relative">
                    <img
                      src={frontendImage}
                    ...
                    <div className="absolute top-3 right-3">
                      <span className="bg-green-500 text-white px-3 py-1.5 rounded-full text-xs font-semibold shadow-md flex items-center gap-1">
